...
<body>
    ...
    <!-- <header id="home">
        <div id="hero" style="
        background-image: url(images/bg<?php $foto = rand(0, 1);
                                        echo $foto ?>.jpg);">
            <div class="container wrap" style="
            display: flex;
            justify-content: space-between;
        ">
                <h1 class="center-m" style="margin-top: 4rem; flex: 1; <?php if ($foto == 1) {
    ...
    <section class="flex wrap" id="apto">
        <div class="pad" style="padding: 6rem; flex:1; text-align: center; min-width: 320px; "><img src="images/logo-grande.png" alt=""></div>
        <div class="pad center-m" style="background: black; color: white; min-width: 320px; flex:2;font-size:180%; padding: 6rem;" class="desc">
            <h3 style="color: #dab97a; margin: 0;">Apartamentos de 252m²</h3>
            <p style="margin-top: 10px">3 Suítes</p>
            <p>4 Vagas</p>
            <p>Depósito</p>
            <p>Amplo terraço</p>
            <p style="margin-top: 10px">OBRAS EM ANDAMENTO.</p>
            <p><a href="#obras" data-lity style="color: #dab97a;">Clique e acompanhe.</a></p>
            <!-- <p style="color: #dab97a;">A partir de R$20mil/m²</p> -->
        </div>
    </section>
    ...
    <section style="background-color: black; color: white; padding: 1rem; text-align: center;">
        ...
        <div class="container">
            ...
            <div class="slider" id="slider1">
                ...
                <figure>
                    <img src="images/perspectivas/MA_Varandas_Fachada_HR_2.jpg" alt="">
                    <legend>Perspectiva artística da Fachada</legend>
                </figure>
                <!-- <figure>
                ...
                <figure>
                    ...
                    <legend>Perspectiva do Salão de Festas e Jogos</legend>
                </figure>
                <figure>
                    <img src="images/perspectivas/MA_Varandas_GourmetFestas02_HR.jpg" alt="">
                    <legend>Perspectiva do Espaço Gourmet</legend>
                </figure>
                <figure>
    ...
    <section>
        <div class="container" style="text-align: center;">
            ...
            <div class="slider" id="slider2">
                ...
                <figure>
                    <img src="images/perspectivas/MA_Varandas_Planta_252m_Op_01.jpg" alt="MA_Varandas_Planta_252m_Op_01">
                    <legend></legend>
                </figure>
                <figure>
                    <img src="images/perspectivas/MA_Varandas_Planta_252m_Op_02.jpg" alt="MA_Varandas_Planta_252m_Op_02">
                    <legend></legend>
                </figure>
                <figure>
                    <img src="images/perspectivas/MA_Varandas_Planta_252m_Op_03.jpg" alt="MA_Varandas_Planta_252m_Op_03">
                    <legend></legend>
                </figure>
                <figure>
                    <img src="images/perspectivas/MA_Varandas_Planta_252m_Op_04.jpg" alt="MA_Varandas_Planta_252m_Op_04">
                    <legend></legend>
                </figure>
                <figure>
                    <img src="images/perspectivas/MA_Varandas_Planta_252m_Op_05.jpg" alt="MA_Varandas_Planta_252m_Op_05">
                    <legend></legend>
                </figure>
                <figure>
                    <img src="images/perspectivas/MA_Varandas_Planta_252m_Padrao.jpg" alt="MA_Varandas_Planta_252m_Padrao">
                    <legend></legend>
                </figure>
                <figure>
                    <img src="images/perspectivas/MA_Varandas_Planta_Cob_Sup.jpg" alt="MA_Varandas_Planta_Cob_Sup">
                    <legend></legend>
                </figure>
                <figure>
                    <img src="images/perspectivas/MA_Varandas_Planta_Cob_Inf.jpg" alt="MA_Varandas_Planta_Cob_Inf">
                    <legend></legend>
                </figure>
                <figure>
                    <img src="images/perspectivas/MunirAbbud_Varanda_Cobertura_HR.jpg" alt="Perspectiva artística Piso superior Cobertura">
                    <legend>Perspectiva artística Piso superior Cobertura</legend>
                </figure>
            </div>
    </section>
    ...
    <section id="contato" class="contato">
        <div class="calendario">
            <div class="flex">
                ...
                <img src="images/ico-calendario.png" alt="ico-calendario">
            </div>
        </div>
        <div class="box">
            ...
            <form action="obrigado.php" method="post">
                <div>
                    ...
                    <textarea class="input" type="text" name="mensagem" placeholder="Mensagem" rows="5" required></textarea>
                </div>
                <div>
